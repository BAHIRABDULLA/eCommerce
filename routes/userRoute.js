...
user_route.get('/cart', auth.isLogin,auth.isActive, userController.loadCart)
...
user_route.get('/checkout', auth.isLogin,auth.isActive, userController.loadCheckout)
...
user_route.get('/wishlist', auth.isLogin,auth.isActive, userController.loadWishlist)
